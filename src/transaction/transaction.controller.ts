...
export class TransactionController {
  ...
  async handlePaystackWebhook(
    ...
    async getUserWallet(
      ...
      return ApiResponse.success("User wallet fetched successfully", res);
    }
